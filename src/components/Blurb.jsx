    ...
    return (
      <div className={this.props.className} style={style.mainDiv}>
        ...
        <ul className="fa-ul">
          ...
          <li><i className="fa-li fa fa-terminal"></i>I've used my skills to contribute to some <a href="https://scholar.google.com/citations?user=R2m4jbUAAAAJ" target="_blank">cool research</a></li>
